    ...
    angular.module('refugeeAuthorEnv')
        .config(['$translateProvider', function ($translateProvider) {
            $translateProvider.translations('de_DE', {
                    ...
                    'ADD_GUIDELINE_BTN': 'Richtlinie hinzufügen',
